...
const services = [
  {
    ...
    description:
      "Build, test, and deploy changes with a predictable release path.",
    icon: "icon-ci-cd.svg",
  },
  {
    title: "Cloud infrastructure",
    description:
      "Structure cloud resources for maintainability, observability, and scale.",
    icon: "icon-cloud-solutions.svg",
  },
  {
    title: "Quality automation",
    description:
      "Add automated checks to detect broken changes before production.",
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-300">
            Three focused areas that keep the landing page clear and easy to
            scan.
          </p>
        </div>
