...
const features = [
  {
    ...
    description:
      "Practical improvements for delivery, environments, and release flow.",
    icon: "icon-devops-transformation.svg",
  },
  {
    title: "Efficient operations",
    description:
      "Cleaner workflows for repeatable infrastructure and support tasks.",
    icon: "icon-efficient-operations.svg",
  },
  {
    title: "CI/CD implementation",
    description:
      "Build, test, and deployment pipelines for static and application workloads.",
    icon: "icon-cicd-implementation.svg",
  },
  {
    title: "Automation",
    description:
      "Small automation layers that reduce manual release and maintenance work.",
      ...
      <div className="container grid items-center gap-12 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-5 text-lg leading-8 text-slate-300">
            The page presents the core areas of a modern delivery service:
            automation, deployment, cloud infrastructure, and operating
            discipline.
          </p>
